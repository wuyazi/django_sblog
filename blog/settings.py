...
#EMAIL_BCMS_QNAME = '13fe1db4a291e6a57574071e8ff3a52c'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'zrmQMIjKIkQLQLwTUeEX',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '_zdkdg$@)&of%j)-)_svz5^e-@-*x#!*8qhv-4mcq!ghiu4chu'
...
#ROOT_URLCONF = os.path.join(os.path.dirname(__file__), '/urls.py').replace('\\','/'),
...
TEMPLATE_DIRS = (
    ...
    os.path.join(os.path.dirname(__file__), '../templates/sblog').replace('\\','/'),
